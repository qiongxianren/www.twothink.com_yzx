...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => ',V#-5/k6P%"da)JNg~^1R$@mvt2QHZ:A3MpjwF_E', //默认数据加密KEY
	'data_cache_key'=> ',V#-5/k6P%"da)JNg~^1R$@mvt2QHZ:A3MpjwF_E',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>',V#-5/k6P%"da)JNg~^1R$@mvt2QHZ:A3MpjwF_E', //加密KEY
