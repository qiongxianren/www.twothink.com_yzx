<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\www\twothink\public/../application/admin/view/default/repair\edit.html";i:1542007390;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<textarea class="text input-large" rows="3" name="content"><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
			</div>
		</div>
		<div class="form-item">
